/*********************************************************************
 *
 * $Id: YLightSensor.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
const char *enumLightSensorType[] = {
    "HUMAN_EYE",
    "WIDE_SPECTRUM",
    "INFRARED",
    "HIGH_RATE",
...
string YFunctionName(void) { return "LightSensor"; }
...
// type of measureType is int (LightSensorType)
/**
...
public:
  ...
  {
    vector<YLightSensor*>* list = enumerateTargets<YLightSensor>(target,modulelist);
    unsigned int i;
 ...
 *
 * @return a floating point number corresponding to the current value of the ambient light, in lux, as
...
public:
  ...
  string getDescription()
  {
    return "Returns the current value of the ambient light, in lux, as a floating point number.";
  }
 ...
 * the sensor, in lux, as a floating point number
 *
...
public:
  ...
  string getDescription()
  {
    return "Returns the uncalibrated, unrounded raw value returned by the sensor, in lux, as a floating point number.";
  }
    ...
    for (i = 0; i < list->size(); i++)
      {
        ...
        string strval =  enumString(attrval,enumLightSensorType);
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), strval, true);
      }
  }
};
...
public:
  ...
  string getDescription()
  {
    return "Modify the light sensor type used in the device.";
  }
  ...
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(INT_ARG, "newval", "a value among HUMAN_EYE, WIDE_SPECTRUM, INFRARED, HIGH_RATE and HIGH_ENERGY", "HUMAN_EYE=0,WIDE_SPECTRUM=1,INFRARED=2,HIGH_RATE=3,HIGH_ENERGY=4", false));
    return res;
  }
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YLightSensor>(cmdList);
    cmdList->push_back((YapiCommand*) (new LightSensor_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_unit()));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new alias_LightSensor_calibrate()));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_resolution()));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_resolution()));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_measureType()));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_measureType()));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_get_timedReport()));
  }
