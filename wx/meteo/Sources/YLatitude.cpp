/*********************************************************************
 *
 * $Id: YLatitude.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "Latitude"; }
...
public:
  ...
  {
    vector<YLatitude*>* list = enumerateTargets<YLatitude>(target,modulelist);
    unsigned int i;
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YLatitude>(cmdList);
    cmdList->push_back((YapiCommand*) (new Latitude_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Latitude_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Latitude_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Latitude_get_unit()));
    cmdList->push_back((YapiCommand*) (new Latitude_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new Latitude_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Latitude_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Latitude_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new Latitude_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new Latitude_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new Latitude_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Latitude_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Latitude_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Latitude_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Latitude_set_resolution()));
    cmdList->push_back((YapiCommand*) (new Latitude_get_resolution()));
    cmdList->push_back((YapiCommand*) (new Latitude_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new apifun_Latitude_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_Latitude_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Latitude_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Latitude_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_Latitude_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Latitude_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Latitude_get_timedReport()));
  }
