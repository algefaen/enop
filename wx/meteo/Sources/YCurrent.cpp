/*********************************************************************
 *
 * $Id: YCurrent.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "Current"; }
...
public:
  ...
  {
    vector<YCurrent*>* list = enumerateTargets<YCurrent>(target,modulelist);
    unsigned int i;
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YCurrent>(cmdList);
    cmdList->push_back((YapiCommand*) (new Current_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Current_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Current_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Current_get_unit()));
    cmdList->push_back((YapiCommand*) (new Current_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new Current_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Current_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Current_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new Current_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new Current_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new Current_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Current_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Current_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Current_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Current_set_resolution()));
    cmdList->push_back((YapiCommand*) (new Current_get_resolution()));
    cmdList->push_back((YapiCommand*) (new Current_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new apifun_Current_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_Current_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Current_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Current_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_Current_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Current_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Current_get_timedReport()));
  }
