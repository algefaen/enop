/*********************************************************************
 *
 * $Id: YHumidity.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "Humidity"; }
...
public:
  ...
  {
    vector<YHumidity*>* list = enumerateTargets<YHumidity>(target,modulelist);
    unsigned int i;
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YHumidity>(cmdList);
    cmdList->push_back((YapiCommand*) (new Humidity_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Humidity_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Humidity_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Humidity_get_unit()));
    cmdList->push_back((YapiCommand*) (new Humidity_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new Humidity_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Humidity_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Humidity_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new Humidity_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new Humidity_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new Humidity_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Humidity_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Humidity_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Humidity_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Humidity_set_resolution()));
    cmdList->push_back((YapiCommand*) (new Humidity_get_resolution()));
    cmdList->push_back((YapiCommand*) (new Humidity_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new apifun_Humidity_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_Humidity_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Humidity_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Humidity_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_Humidity_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Humidity_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Humidity_get_timedReport()));
  }
