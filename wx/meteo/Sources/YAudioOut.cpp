/*********************************************************************
 *
 * $Id: YAudioOut.cpp 20797 2015-07-06 16:49:40Z mvuilleu $
 *
...
string YFunctionName(void) { return "AudioOut"; }
...
public:
  ...
  {
    vector<YAudioOut*>* list = enumerateTargets<YAudioOut>(target,modulelist);
    unsigned int i;
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YAudioOut>(cmdList);
    cmdList->push_back((YapiCommand*) (new AudioOut_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new AudioOut_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new AudioOut_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new AudioOut_get_volume()));
    cmdList->push_back((YapiCommand*) (new AudioOut_set_volume()));
    cmdList->push_back((YapiCommand*) (new AudioOut_get_mute()));
    cmdList->push_back((YapiCommand*) (new AudioOut_set_mute()));
    cmdList->push_back((YapiCommand*) (new AudioOut_get_volumeRange()));
    cmdList->push_back((YapiCommand*) (new AudioOut_get_signal()));
  }
