/*********************************************************************
 *
 * $Id: YAccelerometer.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "Accelerometer"; }
...
public:
  ...
  {
    vector<YAccelerometer*>* list = enumerateTargets<YAccelerometer>(target,modulelist);
    unsigned int i;
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YAccelerometer>(cmdList);
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_unit()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_resolution()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_resolution()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_xValue()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_yValue()));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_zValue()));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_get_timedReport()));
  }
