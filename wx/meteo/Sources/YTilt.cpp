/*********************************************************************
 *
 * $Id: YTilt.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "Tilt"; }
...
public:
  ...
  {
    vector<YTilt*>* list = enumerateTargets<YTilt>(target,modulelist);
    unsigned int i;
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YTilt>(cmdList);
    cmdList->push_back((YapiCommand*) (new Tilt_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Tilt_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Tilt_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Tilt_get_unit()));
    cmdList->push_back((YapiCommand*) (new Tilt_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new Tilt_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Tilt_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Tilt_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new Tilt_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new Tilt_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new Tilt_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Tilt_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Tilt_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Tilt_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Tilt_set_resolution()));
    cmdList->push_back((YapiCommand*) (new Tilt_get_resolution()));
    cmdList->push_back((YapiCommand*) (new Tilt_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_get_timedReport()));
  }
