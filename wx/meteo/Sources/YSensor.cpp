/*********************************************************************
 *
 * $Id: YSensor.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "Sensor"; }
...
public:
  ...
  {
    vector<YSensor*>* list = enumerateTargets<YSensor>(target,modulelist);
    unsigned int i;
...
// type of isScal is bool (bool)
// type of isScal32 is bool (bool)
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YSensor>(cmdList);
    cmdList->push_back((YapiCommand*) (new Sensor_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Sensor_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Sensor_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Sensor_get_unit()));
    cmdList->push_back((YapiCommand*) (new Sensor_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new Sensor_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Sensor_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Sensor_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new Sensor_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new Sensor_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new Sensor_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Sensor_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Sensor_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Sensor_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Sensor_set_resolution()));
    cmdList->push_back((YapiCommand*) (new Sensor_get_resolution()));
    cmdList->push_back((YapiCommand*) (new Sensor_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new apifun_Sensor_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_Sensor_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Sensor_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Sensor_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_Sensor_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Sensor_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Sensor_get_timedReport()));
  }
