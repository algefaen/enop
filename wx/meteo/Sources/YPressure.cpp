/*********************************************************************
 *
 * $Id: YPressure.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "Pressure"; }
...
public:
  ...
  {
    vector<YPressure*>* list = enumerateTargets<YPressure>(target,modulelist);
    unsigned int i;
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YPressure>(cmdList);
    cmdList->push_back((YapiCommand*) (new Pressure_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Pressure_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Pressure_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Pressure_get_unit()));
    cmdList->push_back((YapiCommand*) (new Pressure_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new Pressure_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Pressure_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Pressure_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new Pressure_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new Pressure_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new Pressure_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Pressure_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Pressure_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Pressure_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Pressure_set_resolution()));
    cmdList->push_back((YapiCommand*) (new Pressure_get_resolution()));
    cmdList->push_back((YapiCommand*) (new Pressure_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new apifun_Pressure_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_Pressure_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Pressure_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Pressure_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_Pressure_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Pressure_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Pressure_get_timedReport()));
  }
