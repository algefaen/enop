/*********************************************************************
 *
 * $Id: YMagnetometer.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "Magnetometer"; }
...
public:
  ...
  {
    vector<YMagnetometer*>* list = enumerateTargets<YMagnetometer>(target,modulelist);
    unsigned int i;
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YMagnetometer>(cmdList);
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_unit()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_set_resolution()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_resolution()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_xValue()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_yValue()));
    cmdList->push_back((YapiCommand*) (new Magnetometer_get_zValue()));
    cmdList->push_back((YapiCommand*) (new apifun_Magnetometer_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_Magnetometer_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Magnetometer_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Magnetometer_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_Magnetometer_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Magnetometer_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Magnetometer_get_timedReport()));
  }
