/*********************************************************************
 *
 * $Id: YAltitude.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "Altitude"; }
...
public:
  ...
  {
    vector<YAltitude*>* list = enumerateTargets<YAltitude>(target,modulelist);
    unsigned int i;
...
public:
  ...
  string getMoreInfo()
  {
    return "This enables you to compensate for atmospheric pressure changes due to weather conditions.";
  }
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YAltitude>(cmdList);
    cmdList->push_back((YapiCommand*) (new Altitude_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Altitude_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Altitude_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Altitude_get_unit()));
    cmdList->push_back((YapiCommand*) (new Altitude_set_currentValue()));
    cmdList->push_back((YapiCommand*) (new Altitude_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new Altitude_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Altitude_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Altitude_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new Altitude_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new Altitude_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new Altitude_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Altitude_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Altitude_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Altitude_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Altitude_set_resolution()));
    cmdList->push_back((YapiCommand*) (new Altitude_get_resolution()));
    cmdList->push_back((YapiCommand*) (new Altitude_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new Altitude_set_qnh()));
    cmdList->push_back((YapiCommand*) (new Altitude_get_qnh()));
    cmdList->push_back((YapiCommand*) (new Altitude_get_technology()));
    cmdList->push_back((YapiCommand*) (new apifun_Altitude_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_Altitude_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Altitude_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Altitude_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_Altitude_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Altitude_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Altitude_get_timedReport()));
  }
