/*********************************************************************
 *
 * $Id: YGroundSpeed.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "GroundSpeed"; }
...
public:
  ...
  {
    vector<YGroundSpeed*>* list = enumerateTargets<YGroundSpeed>(target,modulelist);
    unsigned int i;
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YGroundSpeed>(cmdList);
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_unit()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_set_resolution()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_resolution()));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_get_timedReport()));
  }
