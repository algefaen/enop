/*********************************************************************
 *
 * $Id: YCompass.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "Compass"; }
...
public:
  ...
  {
    vector<YCompass*>* list = enumerateTargets<YCompass>(target,modulelist);
    unsigned int i;
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YCompass>(cmdList);
    cmdList->push_back((YapiCommand*) (new Compass_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Compass_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Compass_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Compass_get_unit()));
    cmdList->push_back((YapiCommand*) (new Compass_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new Compass_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Compass_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Compass_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new Compass_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new Compass_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new Compass_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Compass_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Compass_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Compass_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Compass_set_resolution()));
    cmdList->push_back((YapiCommand*) (new Compass_get_resolution()));
    cmdList->push_back((YapiCommand*) (new Compass_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new Compass_get_magneticHeading()));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_get_timedReport()));
  }
