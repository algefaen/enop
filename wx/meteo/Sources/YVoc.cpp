/*********************************************************************
 *
 * $Id: YVoc.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
//--- (YVoc implementation)
string YFunctionName(void) { return "Voc"; }
...
public:
  ...
  {
    vector<YVoc*>* list = enumerateTargets<YVoc>(target,modulelist);
    unsigned int i;
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YVoc>(cmdList);
    cmdList->push_back((YapiCommand*) (new Voc_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Voc_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Voc_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Voc_get_unit()));
    cmdList->push_back((YapiCommand*) (new Voc_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new Voc_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Voc_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Voc_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new Voc_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new Voc_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new Voc_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Voc_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Voc_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Voc_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Voc_set_resolution()));
    cmdList->push_back((YapiCommand*) (new Voc_get_resolution()));
    cmdList->push_back((YapiCommand*) (new Voc_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new apifun_Voc_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_Voc_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Voc_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Voc_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_Voc_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Voc_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Voc_get_timedReport()));
  }
