/*********************************************************************
 *
 * $Id: YVoltage.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "Voltage"; }
...
public:
  ...
  {
    vector<YVoltage*>* list = enumerateTargets<YVoltage>(target,modulelist);
    unsigned int i;
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YVoltage>(cmdList);
    cmdList->push_back((YapiCommand*) (new Voltage_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Voltage_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Voltage_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Voltage_get_unit()));
    cmdList->push_back((YapiCommand*) (new Voltage_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new Voltage_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Voltage_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Voltage_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new Voltage_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new Voltage_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new Voltage_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Voltage_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Voltage_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Voltage_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Voltage_set_resolution()));
    cmdList->push_back((YapiCommand*) (new Voltage_get_resolution()));
    cmdList->push_back((YapiCommand*) (new Voltage_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_get_timedReport()));
  }
