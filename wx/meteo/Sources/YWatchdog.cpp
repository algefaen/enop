/*********************************************************************
 *
 * $Id: YWatchdog.cpp 19609 2015-03-05 10:38:00Z seb $
 *
...
string YFunctionName(void) { return "Watchdog"; }
...
public:
  ...
  {
    vector<YWatchdog*>* list = enumerateTargets<YWatchdog>(target,modulelist);
    unsigned int i;
...
public:
  ...
  string getDescription()
  {
    return "Returns the watchdog runing state at module power on.";
  }
...
public:
  ...
  string getDescription()
  {
    return "Changes the watchdog runningsttae at module power on.";
  }
  ...
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(INT_ARG, "newval", "either OFF or ON, according to the watchdog runningsttae at module power on", "OFF=0,ON=1", false));
    return res;
  }
...
public:
  ...
  string getMoreInfo()
  {
    return "When the watchdog is running, this function must be called on a regular basis to prevent the watchog to trigger";
  }
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YWatchdog>(cmdList);
    cmdList->push_back((YapiCommand*) (new Watchdog_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Watchdog_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Watchdog_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Watchdog_get_state()));
    cmdList->push_back((YapiCommand*) (new Watchdog_set_state()));
    cmdList->push_back((YapiCommand*) (new Watchdog_get_stateAtPowerOn()));
    cmdList->push_back((YapiCommand*) (new Watchdog_set_stateAtPowerOn()));
    cmdList->push_back((YapiCommand*) (new Watchdog_get_maxTimeOnStateA()));
    cmdList->push_back((YapiCommand*) (new Watchdog_set_maxTimeOnStateA()));
    cmdList->push_back((YapiCommand*) (new Watchdog_get_maxTimeOnStateB()));
    cmdList->push_back((YapiCommand*) (new Watchdog_set_maxTimeOnStateB()));
    cmdList->push_back((YapiCommand*) (new Watchdog_get_output()));
    cmdList->push_back((YapiCommand*) (new Watchdog_set_output()));
    cmdList->push_back((YapiCommand*) (new Watchdog_get_pulseTimer()));
    cmdList->push_back((YapiCommand*) (new alias_Watchdog_pulse()));
    cmdList->push_back((YapiCommand*) (new alias_Watchdog_delayedPulse()));
    cmdList->push_back((YapiCommand*) (new Watchdog_get_countdown()));
    cmdList->push_back((YapiCommand*) (new Watchdog_get_autoStart()));
    cmdList->push_back((YapiCommand*) (new Watchdog_set_autoStart()));
    cmdList->push_back((YapiCommand*) (new Watchdog_get_running()));
    cmdList->push_back((YapiCommand*) (new Watchdog_set_running()));
    cmdList->push_back((YapiCommand*) (new alias_Watchdog_resetWatchdog()));
    cmdList->push_back((YapiCommand*) (new Watchdog_get_triggerDelay()));
    cmdList->push_back((YapiCommand*) (new Watchdog_set_triggerDelay()));
    cmdList->push_back((YapiCommand*) (new Watchdog_get_triggerDuration()));
    cmdList->push_back((YapiCommand*) (new Watchdog_set_triggerDuration()));
  }
