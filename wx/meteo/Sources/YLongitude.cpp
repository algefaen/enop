/*********************************************************************
 *
 * $Id: YLongitude.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "Longitude"; }
...
public:
  ...
  {
    vector<YLongitude*>* list = enumerateTargets<YLongitude>(target,modulelist);
    unsigned int i;
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YLongitude>(cmdList);
    cmdList->push_back((YapiCommand*) (new Longitude_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new Longitude_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new Longitude_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new Longitude_get_unit()));
    cmdList->push_back((YapiCommand*) (new Longitude_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new Longitude_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Longitude_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new Longitude_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new Longitude_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new Longitude_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new Longitude_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Longitude_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new Longitude_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Longitude_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new Longitude_set_resolution()));
    cmdList->push_back((YapiCommand*) (new Longitude_get_resolution()));
    cmdList->push_back((YapiCommand*) (new Longitude_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_get_timedReport()));
  }
