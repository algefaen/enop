/*********************************************************************
 *
 * $Id: YCarbonDioxide.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "CarbonDioxide"; }
...
public:
  ...
  {
    vector<YCarbonDioxide*>* list = enumerateTargets<YCarbonDioxide>(target,modulelist);
    unsigned int i;
...
public:
  ...
  string getDescription()
  {
    return "Modifies Automatic Baseline Calibration period, in hours.";
  }

  string getMoreInfo()
  {
    return "If you need to disable automatic baseline calibration (for instance when using the sensor in an environment that is constantly above 400ppm CO2), set the period to -1. Remember to call the saveToFlash() method of the module if the modification must be kept.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_CarbonDioxide_triggetBaselineCalibration : public YapiCommand /* arguments: */
{
public:

  string getName()
  {
    return "triggetBaselineCalibration";
  }
  ...
  void execute(string target,vector<YModule*> *modulelist,string resultformat, vector<ArgumentDesc*>* args , vector<SwitchDesc*>* switches)
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        (*list)[i]->triggetBaselineCalibration();
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
      }
  }
};
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_CarbonDioxide_triggetZeroCalibration : public YapiCommand /* arguments: */
{
public:

  string getName()
  {
    return "triggetZeroCalibration";
  }
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YCarbonDioxide>(cmdList);
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_get_unit()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_set_resolution()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_get_resolution()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_get_abcPeriod()));
    cmdList->push_back((YapiCommand*) (new CarbonDioxide_set_abcPeriod()));
    cmdList->push_back((YapiCommand*) (new apifun_CarbonDioxide_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_CarbonDioxide_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_CarbonDioxide_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_CarbonDioxide_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_CarbonDioxide_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_CarbonDioxide_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_CarbonDioxide_triggetBaselineCalibration()));
    cmdList->push_back((YapiCommand*) (new apifun_CarbonDioxide_triggetZeroCalibration()));
    cmdList->push_back((YapiCommand*) (new apifun_CarbonDioxide_get_timedReport()));
  }
