/*********************************************************************
 *
 * $Id: YGenericSensor.cpp 20400 2015-05-21 14:58:16Z mvuilleu $
 *
...
string YFunctionName(void) { return "GenericSensor"; }
...
public:
  ...
  {
    vector<YGenericSensor*>* list = enumerateTargets<YGenericSensor>(target,modulelist);
    unsigned int i;
...
public:
  ...
  string getDescription()
  {
    return "Returns the measured value of the electrical signal used by the sensor.";
  }
...
public:
  ...
  string getMoreInfo()
  {
    return "As a side effect, the range modification may automatically modify the display resolution.";
  }
...
public:
  ...
  string getMoreInfo()
  {
    return "If your electric signal reads positif when it should be zero, setup a positive signalBias of the same value to fix the zero shift.";
  }
...
public:
  ...
  string getMoreInfo()
  {
    return "A positive bias means that the signal is over-reporting the measure, while a negative bias means that the signal is underreporting the measure.";
  }
...
public:
  ...
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(INT_ARG, "newval", "a value among HIGH_RATE, HIGH_RATE_FILTERED, LOW_NOISE and LOW_NOISE_FILTERED corresponding to the electric signal sampling method to use", "HIGH_RATE=0,HIGH_RATE_FILTERED=1,LOW_NOISE=2,LOW_NOISE_FILTERED=3", false));
    return res;
  }
...
void RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YGenericSensor>(cmdList);
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_logicalName()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_set_logicalName()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_advertisedValue()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_unit()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_set_unit()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_currentValue()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_set_lowestValue()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_lowestValue()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_set_highestValue()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_highestValue()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_currentRawValue()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_logFrequency()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_set_logFrequency()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_set_reportFrequency()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_set_resolution()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_resolution()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_sensorState()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_signalValue()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_signalUnit()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_signalRange()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_set_signalRange()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_valueRange()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_set_valueRange()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_set_signalBias()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_signalBias()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_get_signalSampling()));
    cmdList->push_back((YapiCommand*) (new GenericSensor_set_signalSampling()));
    cmdList->push_back((YapiCommand*) (new apifun_GenericSensor_isSensorReady()));
    cmdList->push_back((YapiCommand*) (new apifun_GenericSensor_startDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_GenericSensor_stopDataLogger()));
    cmdList->push_back((YapiCommand*) (new apifun_GenericSensor_get_recordedData()));
    cmdList->push_back((YapiCommand*) (new apifun_GenericSensor_calibrateFromPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_GenericSensor_loadCalibrationPoints()));
    cmdList->push_back((YapiCommand*) (new apifun_GenericSensor_zeroAdjust()));
    cmdList->push_back((YapiCommand*) (new apifun_GenericSensor_get_timedReport()));
  }
